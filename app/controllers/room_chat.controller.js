...
// các chức năng liên quan tới room
exports.create_room = (req, res) => {
    res.send({ message: "create handler room" });
};

exports.findAll_room = (req, res) => {
    res.send({ message: "findAll handler room" });
};

exports.findOne_room = (req, res) => {
    res.send({ message: "fondOne handler room" });
};


exports.update_room = (req, res) => {
    res.send({ message: "update handler room" });
}

exports.delete_room = (req, res) => {
    res.send({ message: "delete handler room" });
};
